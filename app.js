...
function renderEvidence(){
 ...
 document.querySelectorAll('[data-remove-evidence]').forEach(b=>b.onclick=()=>{window.SupplierProofAttachments?.remove(b.dataset.removeEvidence);state.evidence=state.evidence.filter(x=>x.id!==b.dataset.removeEvidence);save();renderEvidence();renderResults();});
}
